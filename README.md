...
Descriptive analysis of revenue, units sold, and gross income
...
Time-based trend analysis of revenue and transactions
...
Short time horizon limits long-term trend analysis

No inventory or promotion data included

Customer data is aggregated, not individual-level

Future Enhancements

Add inventory and stock-out data

Introduce forecasting and demand planning models

Implement a star schema for scalability

Extend customer analysis using RFM segmentation

Conclusion

This project demonstrates an end-to-end retail analytics workflow, from raw data to actionable business insight. It reflects practical decision-making, clean analytical logic, and professional visualization standards suitable for junior to mid-level data analytics and BI roles.
